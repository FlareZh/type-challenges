...
type Unique<T, U = never> = T extends [infer First, ...infer Rest]
  ? true extends (U extends U ? Equal<[First], U> : false)
    ? Unique<Rest, U>
    : [First, ...Unique<Rest, [First] | U>]
  : T

type A = [3] extends [3 | 4] ? true : false
